...
description: "Configure Mastra Fine-Grained Authorization for resource-level permissions that map routes to actions and scope stored resources for enterprise users."
packages:
  - "@mastra/auth-workos"
  - "@mastra/core"
  - "@mastra/mcp"
...
```typescript
import type { FGARouteConfig, FGARouteResolver } from '@mastra/core/auth/authorization'
...
import type { FGACheckParams, IFGAProvider, MastraFGAPermissionInput } from '@mastra/core/auth/authorization'
