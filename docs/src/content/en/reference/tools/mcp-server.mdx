...
<PropertiesTable
  ...
  },
  {
    ...
    description: 'Optional request guards. See the options table below for more details.',
    optional: true,
  },
]}
/>
...
<PropertiesTable
  content={[
  {
    name: 'enableDnsRebindingProtection',
    type: 'boolean',
    description:
      'If `true`, the `Host` and `Origin` headers are validated against `allowedHosts` and `allowedOrigins` before the request is handled. Defaults to `false`.',
    optional: true,
  },
  {
    name: 'allowedHosts',
    type: 'string[]',
    description: 'Hosts (`host[:port]`) accepted when DNS rebinding protection is enabled.',
    optional: true,
  },
  {
    name: 'allowedOrigins',
    type: 'string[]',
    description: 'Origins accepted when DNS rebinding protection is enabled.',
    optional: true,
  },
]}
/>
